...
const Education = ({ enableNext }) => {
    ...
    const AddNewEducation = () => {
        setEducationalList([...educationalList, { universityName: '', degree: '', major: '', startDate: '', endDate: '', description: '' }])
    }
    ...
    const onSave = async () => {
        setLoading(true);
        enableNext(true);
        await db.update(UserResumes).set({ education: educationalList })
        ...
        <div className='p-5 shadow-lg rounded-lg border-t-primary border-t-4 mt-10 bg-white'>
            ...
            <div className='flex justify-between'>
                <div className='flex gap-2'>
                    <Button variant="outline" onClick={AddNewEducation} className="text-primary"> + Add More </Button>
